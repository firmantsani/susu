...
$headers_2 = [
    ...
    "sec-fetch-user: ?1",
    "sec-fetch-dest: document",
    "referer: https://enaak.store/cart",
    "accept-language: en,id-ID;q=0.9,id;q=0.8,en-US;q=0.7",
    "priority: u=0, i"
];
...
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, "https://enaak.store/wp-admin/admin-ajax.php");
curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
curl_setopt($ch, CURLOPT_HTTP_VERSION, CURL_HTTP_VERSION_2_0);
...
$headers_4 = [
    ...
    "sec-fetch-user: ?1",
    "sec-fetch-dest: document",
    "referer: https://enaak.store/thank-you",
    "accept-language: en,id-ID;q=0.9,id;q=0.8,en-US;q=0.7",
    "priority: u=0, i"
];
curl_setopt($ch, CURLOPT_URL, "https://enaak.store/thank-you");
...
foreach ($shortcodeDivs as $div) {
    if ($div->getAttribute('class') === 'elementor-shortcode') {
        ...
        foreach ($images as $img) {
            ...
            if (strpos($src, 'enaak.store/barcode') !== false) {
